                                        ...
                                        <div class="card card-bordered card-preview">											
                                            <div class="card-inner">
                                                <div class="row gy-4">													
                                                    ...
                                                    <div class="col-3">
														<p class="text-soft">Jumlah mengikut halaman: </p>
														<h3 class="text-soft">RM 8,000.00.</h3>
                                                    </div>
													<div class="col-3">
														<p class="text-soft">Jumlah keseluruhan: </p>
														<h3 class="text-soft">RM 8,000.00.</h3>
                                                    </div>													
                                                </div>
                                            </div>
									...
									<div class="card">
                                        <div class="card-inner">
                                            <div class="nk-block-between-md g-3">                                                
												<div class="g">
													<div class=" drodown">
															<a href="#" class="dropdown-toggle dropdown-indicator btn btn-outline-secondary btn-light" data-bs-toggle="dropdown">Download</a>
